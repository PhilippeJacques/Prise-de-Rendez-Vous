...
// import { sendSomeData } from "./Dashboard";
...
class AppointmentApp extends Component {
  ...
  handleSubmit() {
    ...
    const newAppointment = {
      ...
      nameAssocs: this.props.location.state,
        ...
        >
          ...
          >
            ...
            >
              <Step>
                <StepLabel>
                Choisissez un jour disponible pour votre rendez-vous avec -<strong>{ this.props.location.state}</strong>
              ...
              <Step disabled={!data.appointmentDate}>
                <StepLabel>
                Choisissez une heure disponible pour votre rendez-vous
                </StepLabel>
                <StepContent>
                  <SelectField
              ...
              <Step>
                <StepLabel>
                Partagez vos coordonnées avec nous et nous vous enverrons un
                  rappel
                </StepLabel>
                <StepContent>
                  <p>
