...
class Register extends Component{
    ...
    render(){
        const {name, email, phone, role,password, password2 ,errors} = this.state;

        return(
          <div className="makeitclean">
            ...
            <form className="signup-form"  onSubmit={this.onSubmit}>
               ...
               <div><Link to="/"><i className="fa fa-arrow-circle-left  "></i> Back to Home</Link></div>
                ...
                <label for="pet-select">écrire etudiant ou association:</label>
                <div className="form-group">
                    <input type="text" 
                           id="role" 
                           placeholder="etudiant ou association" 
                           value={role}
                           error={errors.role} 
                           onChange={this.onChange} 
                           className={classnames("form-control", {
